...
class CustomGaugeLightWidget extends StatefulWidget {
  @override
  _CustomGaugeLightWidgetState createState() => _CustomGaugeLightWidgetState();
}

class _CustomGaugeLightWidgetState extends State<CustomGaugeLightWidget>
  ...
  Future<double?> fetchGaugeData() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data['light'] != null && data['light'] is num) {
          return (data['light'] as num).toDouble();
        } else {
