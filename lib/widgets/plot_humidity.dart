...
class CustomChartHumidityWidget extends StatefulWidget {
  final String title;
  final String xAxisTitle;
  final String yAxisTitle;

  const CustomChartHumidityWidget({
    Key? key,
    required this.title,
  ...
  @override
  _CustomChartHumidityWidgetState createState() =>
      _CustomChartHumidityWidgetState();
}

class _CustomChartHumidityWidgetState extends State<CustomChartHumidityWidget> {
  // Define la URL aquí
