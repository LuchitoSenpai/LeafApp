...
class CustomChartTemperatureWidget extends StatefulWidget {
  final String title;
  final String xAxisTitle;
  final String yAxisTitle;

  const CustomChartTemperatureWidget({
    Key? key,
    required this.title,
  ...
  @override
  _CustomChartTemperatureWidgetState createState() =>
      _CustomChartTemperatureWidgetState();
}

class _CustomChartTemperatureWidgetState
    extends State<CustomChartTemperatureWidget> {
  // Define la URL aquí
